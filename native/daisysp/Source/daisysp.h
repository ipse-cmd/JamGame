...
/** LGPL Modules — intentionally NOT vendored in Jammin (MIT-only). The DaisySP-LGPL/ tree was
 *  removed to avoid LGPL obligations; do not define USE_DAISYSP_LGPL. See this module's VENDORING.md. */
